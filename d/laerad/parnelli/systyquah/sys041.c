...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the north, east and southwest here.  "+
    ...
    set_exits( ([
        "southwest":"/d/laerad/parnelli/systyquah/sys042",
        "east":"/d/laerad/parnelli/systyquah/sys012",
	"north":"/d/laerad/parnelli/systyquah/sys047"
    ]) );
}
void reset(){
    ::reset();
