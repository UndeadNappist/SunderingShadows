...
void create(){
    ...
    set_long(
        ...
        "street leads off to the west, northeast and southeast here.  "+
    ...
    set_exits( ([
        "northeast":"/d/laerad/parnelli/systyquah/sys050",
	"southeast":"/d/laerad/parnelli/systyquah/sys055",
        "west":"/d/laerad/parnelli/systyquah/sys048"
    ]) );
}
