...
void create(){
    ...
    set_exits( ([
	"north":"/d/laerad/plains/plains54",
	"south":"/d/laerad/swamp/swamp06",
	"west":"/d/laerad/swamp/swamp03",
	"east":"/d/laerad/swamp/swamp07"
    ]) );
}
void reset(){
    ::reset();
    if(!present("death")){
	new("/d/laerad/mon/cdeath")->move(this_object());
    }
}
