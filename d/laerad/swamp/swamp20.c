...
void create(){
    ...
    set_exits( ([
	"northeast":"/d/laerad/swamp/swamp21",
	"northwest":"/d/laerad/swamp/swamp08",
	"east":"/d/laerad/swamp/swamp32",
	"southwest":"/d/laerad/swamp/swamp31"
    ]) );
}
void reset(){
    ::reset();
    if(!present("skuz")){
	new("/d/laerad/mon/skuz")->move(this_object());
    }
}
