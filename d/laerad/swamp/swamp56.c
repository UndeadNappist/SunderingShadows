...
void create(){
    ...
    set_exits( ([
	"east":"/d/laerad/swamp/swamp57",
	"west":"/d/laerad/swamp/swamp55",
	"north":"/d/laerad/swamp/swamp50",
	"northwest":"/d/laerad/swamp/swamp49"
    ]) );
}
void reset(){
    ::reset();
    if(!present("hydra")){
	new("/d/laerad/mon/hydra10")->move(this_object());
	new("/d/laerad/mon/hydra12")->move(this_object());
    }
}
