...
void create(){
	...
	"\nTo the north you see the walls of Systyquah village."
    );
    set("night long",
        ...
        "for very long."
	"\nTo the north you see many lights coming from Systyquah village."
    );
    ...
    set_exits( ([
	"west":"/d/laerad/swamp/swamp18",
	"north":"/d/laerad/parnelli/systyquah/sys021"
    ]) );
}
