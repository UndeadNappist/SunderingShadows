...
void create(){
    ...
    set_exits( ([
	"northwest":"/d/laerad/swamp/swamp24",
	"northeast":"/d/laerad/swamp/swamp26",
	"southwest":"/d/laerad/swamp/swamp46",
	"east":"/d/laerad/swamp/swamp36"
    ]) );
}
void reset(){
    ::reset();
    ...
    if(!present("hydra")){
	new("/d/laerad/mon/hydra8")->move(this_object());
    }
}
