...
void create(){
    ...
    set_items(([
        ({"portal", "runes"}) : "%^RESET%^%^C059%^This portal crawls with living darkness, its surface undulating like a pool of black serpents slithering across the surface of a murky lake. The border of the portal is carved directly from the wall of the cave, runes glowing with a sickly green light carved into its surface. Despite the fact that its likely a terrible idea, you feel the urge to reach out and trace the runes.%^CRST%^",
   ]));
