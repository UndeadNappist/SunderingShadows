...
void create(){
    ...
    set_obvious_short("%^GREEN%^snake-like longbow%^RESET%^");
   	...
   	set_long("%^GREEN%^This bow seem to be carved out of one piece of %^BOLD%^as%^RESET%^%^ORANGE%^p %^BOLD%^%^GREEN%^w%^RESET%^%^ORANGE%^oo%^BOLD%^%^GREEN%^d%^RESET%^%^GREEN%^. The %^BOLD%^w%^RESET%^%^ORANGE%^oo%^BOLD%^%^GREEN%^d %^RESET%^%^GREEN%^itself have been carved with incredible details to resemble the feared %^BOLD%^%^BLACK%^A%^GREEN%^sp sn%^BLACK%^a%^GREEN%^ke%^RESET%^%^GREEN%^. If you look at it long enough, you will almost swear that the %^YELLOW%^e%^BLACK%^y%^ORANGE%^es %^RESET%^%^GREEN%^of the %^BOLD%^as%^RESET%^%^ORANGE%^p %^BOLD%^%^GREEN%^b%^RESET%^%^ORANGE%^o%^BOLD%^%^GREEN%^w %^RESET%^%^GREEN%^are blinking back at you. The middle of the %^BOLD%^b%^BLACK%^o%^GREEN%^w %^RESET%^%^GREEN%^is swirling in on itself around the handle. Almost as to resemble the %^BOLD%^As%^BLACK%^p %^GREEN%^b%^BLACK%^o%^GREEN%^w %^BLACK%^coils %^RESET%^%^GREEN%^around the wielders arm. Just above the handle and facing the targets of the %^BOLD%^b%^BLACK%^o%^GREEN%^w%^RESET%^%^GREEN%^, a large %^BOLD%^%^BLACK%^a%^GREEN%^sp sn%^BLACK%^a%^GREEN%^ke h%^BLACK%^e%^GREEN%^ad %^RESET%^%^GREEN%^is carved with %^RED%^open maw %^GREEN%^and dangerous looking %^BOLD%^%^WHITE%^fangs %^RESET%^%^GREEN%^made from %^BOLD%^%^WHITE%^ivory%^RESET%^\n");
   	set_value(1500);
   	set_property("enchantment",4);
    set_lore("The Asp Bow is a creation both feared and marveled. It is said that only the Medusa are able to bind the spirit of a Asp snake to the bow willingly in a way that the bow inherits the powers of the snake. Not much are known about the creation of the bow however, as very few live to tell the tale of meeting a Medusa.. -- Sallonir deldor, Bard of Torm");
    ...
    if(random(1000)<150){
        switch(random(20)){
            case 0..4:
                ...
                tell_object(targi,ETO->QCN+"'s transforms the arrow into an %^GREEN%^asp snake%^ORANGE%^ and shoots it at you!");
                tell_room(EETO,ETO->QCN+"'s%^ORANGE%^ bow transforms the arrow into an %^GREEN%^asp snake%^ORANGE%^ and fires it at "+targi->QCN+"%^RESET%^",ETO);
			   	snake = new(OBJ"aspsnake");
                snake->move(targi);
                snake->hurt(targi);
                counter ++;
                return 1;
