...
void create()
{
    ...
    set("long", "This is a large boulder-like creature with appendages resembling hands and feet. It is about 10 feet tall, and blends almost completely into the surrounding rock.");
    set_overall_ac(-15);
    set_race("rock");
