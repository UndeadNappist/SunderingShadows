...
void create(){
      ...
      set_read("\n\n%^CYAN%^Warning!  The waters are extremely dangerous!\n \n"+
                ...
                "Be wary the %^CYAN%^water%^MAGENTA%^ lest it claim your life too..\n\n"+
                "%^GREEN%^OOC:  Underwater area recommended level 40+.\n");
      set_language("elven");
      set_weight(10000);
      set_value(0);
}
