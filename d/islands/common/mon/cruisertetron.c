...
void create()
{
    ...
    set_skill("athletics", 20); //upping from 10, which makes parry chance seem low
}
...
void desoul(object targ)
{
    ...
    if (!targ->will_save(75) && !targ->query_property("no death") && !FEATS_D->usable_feat(targ, "death ward")) {
