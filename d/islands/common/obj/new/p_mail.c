...
void create()
{
    ...
    set_id(({ "crystal mail", "mail", "mail shirt", "crystal shirt", "mesh shirt", "mesh mail", "crystal mesh", " pristmatic mail" }));
...
int wear_func()
{
    tell_room(EETO, "%^BOLD%^Pulling the armor on" +
...
int remove_func()
{
    tell_room(EETO, "%^BOLD%^Pulling off the mail shirt" +
