...
void create()
{
      ...
      /*if (sizeof(children(file_name(TO)))>1){
          children(file_name(TO))[0]->move(find_object_or_load("/d/shadowgate/void"));
          remove();
      }*/
