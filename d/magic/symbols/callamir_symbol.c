...
void init(){
   ...
   // A thin silver thread loops around the rabbit-shaped stone, whose legs are outstretched in defiance of its bondage.
   // When observed from afar, its wearers movements lend it a lifelike bounce, while the cloudy-white coloration of the quartz appears to paint a fluffy texture over its lapin form.
