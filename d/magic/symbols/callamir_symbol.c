...
void init(){
   ...
   // When observed from afar, its wearer's movements lend it a lifelike bounce, while the cloudy-white coloration of the quartz appears to paint a fluffy texture over its lapine form.
