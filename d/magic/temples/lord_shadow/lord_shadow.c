...
void create() {
   ...
   ({ "obsidian", "mirror" }) : "%^C060%^The pillars and walls encircle a large open area, centered upon what seems to be a great vertical mirror of what looks like polished obsidian that emanates an aura of the deepest dread. Upon the surface of the mirror plays dark movements and fluttering and you get the impression you are looking directly into the Plane of Shadows itself.%^CRST%^",
