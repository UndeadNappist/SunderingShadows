...
void create() {
   ...
   set_listen("default","You hear the hushed whispers of the acolytes and the faithful all around you.");
   set_items(([
   ...
   ({ "obsidian", "mirror" }) : "%^C060%^The pillars and walls encircle a large open area, centered upon what seems to be a great vertical mirror of what looks like polished obisidian that emanates an aura of the deepest dread. Upon the surface of the mirror plays dark movements and fluttering and you get the impression you are looking into the Plane of Shadows itself.%^CRST%^",
