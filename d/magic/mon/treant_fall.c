...
void create()
{
    ...
    set_short("%^RESET%^%^ORANGE%^Lum%^RED%^b%^ORANGE%^eri"
              "%^YELLOW%^n%^RESET%^%^ORANGE%^g Tre%^RED%^a%^ORANGE%^nt%^RESET%^");
    set_long("%^RESET%^%^ORANGE%^The thick trunk of this treant is "
             "covered in deep woody brown bark gilded with veins of %^RESET%^"
             "silver%^ORANGE%^.  The vast reach of the spreading branches are "
             "covered with a riot of le%^YELLOW%^a%^RESET%^%^ORANGE%^ve%^YELLOW%^s "
             "%^RESET%^%^ORANGE%^in warm shades of ora%^YELLOW%^n%^RESET%^%^ORANGE%^ge, "
             "%^RED%^r%^BOLD%^e%^RESET%^%^RED%^d%^ORANGE%^, and %^YELLOW%^g"
             "%^RESET%^%^ORANGE%^o%^YELLOW%^ld%^RESET%^%^ORANGE%^.  The treant "
