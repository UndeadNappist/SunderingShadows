...
string* owners2 = ({ "silesse", "vicdaerrysn", "balur", "maenoh", "circe" });
...
void create()
{
    ...
    set_door("door", ROOMS "chamber_of_reckoning", "east", "rilynath_sigil", "runes");
    ...
    lock_difficulty("door", LOCKS_LEGENDARY, "runes");
