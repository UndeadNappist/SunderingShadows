...
"You are standing on Starlight Avenue, which leads south back to the Offestry town square and continues north.  The cobblestone %^ORANGE%^streets %^RESET%^are smooth beneath your feet, granting passage to the light but "
"steady stream of %^CYAN%^traffic %^RESET%^that passes through the town on a daily basis.  The street is bordered on both "
"sides by a jumble of %^RED%^buildings%^RESET%^. To the east the closest of which is the healer with its doors open to welcome customers. "
"To the west the closest of which is the clothing store with its doors open to welcome customers.%^RESET%^\n");
...
"styles give a unique appearance to the cosy town around you, where no two buildings are the same.  Nearby is the healer and "
"the clothing store.%^RESET%^",
   ]));
   set_exits(([
      "north":MAINTOWN"nstreet2",
      "south":MAINTOWN"square",
      "east":MAINTOWN"healer",
      "west":MAINTOWN"clothing",
   ]));
}
