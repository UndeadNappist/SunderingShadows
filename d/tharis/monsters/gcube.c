...
void create(){
	...
	set("short","A large gelatinous cube");
	set("long",
@OLI
	This gelatinous cube is made of a transluscent substance. You see it 
coming at you without halt. All the slime on the walls is being eaten away 
by it's touch. In side it you can make out some objects.
OLI
	);
	set_hd(9,3);
	set_hp(40);
