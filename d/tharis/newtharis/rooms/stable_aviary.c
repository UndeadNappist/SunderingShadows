...
void create(){
	...
	set_items(([
			"fortress" : "%^RESET%^%^CRST%^%^C244%^Above the city looms the ever-present %^C241%^Shadovar fortress%^C244%^, casting the entire area into a state of perpetual %^RESET%^%^C057%^t%^C056%^w%^C055%^i%^C063%^l%^C062%^i%^C063%^g%^C055%^h%^C057%^t%^RESET%^%^C244%^. From this vantage point, one can see that the floating city appears to have been built upon what appears to be an inverted mountain top. The jagged rock beneath is littered with %^RESET%^%^C240%^caves%^RESET%^%^C244%^, many alight with the %^RESET%^%^C163%^glow %^RESET%^%^C244%^of %^RESET%^%^C161%^f%^C162%^a%^C163%^e%^C164%^r%^C165%^i%^C201%^e %^C200%^f%^C199%^i%^C198%^r%^C197%^e%^RESET%^%^C244%^. It is difficult to imagine the sort of magical prowess that would be needed not only to prepare the platform on which the city rests, let alone the power required to keep it afloat.%^CRST%^",
