...
void create() {
    ...
    //({"ceiling", "bas-relief"}): "",
    //"plants": "%^RESET%^%^C015%^Large %^RESET%^%^C231%^white ceramic pots %^RESET%^%^C015%^sit in the corners of the room, containing magnificent elephant ear plants in an exotic black hue, their broad leaves laced with veins of green and violet.",
