...
void create(){
  ...
  set_name("bicorn");
  set_short("%^RESET%^%^C242%^S%^C241%^l%^C240%^e%^C242%^e%^C241%^k %^CRST%^%^C240%^bic%^C124%^o%^C240%^rn%^CRST%^");
  ...
  set_vehicle_short("%^RESET%^%^C242%^S%^C241%^l%^C240%^e%^C242%^e%^C241%^k %^CRST%^%^C240%^bic%^C124%^o%^C240%^rn%^RESET%^");
  set_riding_level(15);
}
