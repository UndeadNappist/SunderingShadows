...
void create(){
   ...
   set_my_mess(({
       ...
       "The cinnamon sweetness of the bread pudding is enhanced by the delightful taste of the ice cream.\n",
       ...
       "You inhale the sweet fragrance of jasmine as you sip the tea, feeling it soothe your throat.\n",
   ...
   set_your_mess(({
    ...
    set_menu_long(({
        ...
        "This wine glass is filled with %^MAGENTA%^deep maroon wine%^RESET%^ that gives off the heady aroma of plums.  Near the center of the glass, the liquid grows more translucent as the light brightens its color, bringing to mind the hue of fresh plums themselves.  A slight fragrance of cinnamon rises from the glass as well.\n",
