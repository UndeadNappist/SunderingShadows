...
void create() {
    ...
    obj->set_long("This small board has been established outside the Rhapsody Inn to alert passers-by of the upcoming events that are to take place here. Shows, dances, gatherings, poetry recitals, songs, these are just a few of the many events held at the Rhapsody. If you are not involved with these events, then please do not post on this board or remove posts of the events.\n");
