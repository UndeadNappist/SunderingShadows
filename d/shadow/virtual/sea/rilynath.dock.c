...
" long ivory dock juts out.  The sprawling dock seems to be large enough to accommodate most any size"
...
" %^CYAN%^tu%^RESET%^%^CYAN%^rqu%^BOLD%^oise wa%^RESET%^%^CYAN%^t%^BOLD%^ers%^WHITE%^, while to"
" the west, the edges of a %^RESET%^%^GREEN%^majestic forest %^BOLD%^%^WHITE%^springs high into"
...
" an imposing %^BLACK%^cliff face %^WHITE%^that casts a long %^BLACK%^shadow %^WHITE%^over the beach. \n");
  ...
  "forest":"%^RESET%^%^GREEN%^To the west, a %^BOLD%^majestic forest"
...
" of %^CYAN%^health %^GREEN%^and %^CYAN%^radiance %^GREEN%^against the western horizon.",
  ({"dock", "ivory dock"}):"%^BOLD%^%^WHITE%^Sprouting from the %^CYAN%^crystalline sea %^WHITE%^itself, the spiraling supports"
" of this %^RESET%^ivory dock %^BOLD%^twist and turn around one another in their ascent before spreading finger-like tips to support "
