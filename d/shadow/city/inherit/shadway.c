...
void create(){
   ...
   set_name("Shadow Way");
   set_short("%^BLUE%^Shadow Way, Shadow%^RESET%^");
   set_long("%^BLUE%^Shadow Way, Shadow%^RESET%^\n "+
      "This bustling avenue travels along the west-east axis through "+
