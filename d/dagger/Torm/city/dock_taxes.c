...
void create(){
    ...
    set_long("%^RESET%^%^CRST%^%^C130%^A Large Office on the Boardwalk.%^CRST%^\n%^RESET%^%^CRST%^%^C136%^This office stands on the lower boardwalk looking out over the Dagger Sea. The office is tidy, with a simple wooden desk and chair in the southern part of the room, leaving enough space for sailors to travel between the two doors. A locked cabinet stands in the southwestern corner, and numerous papers and folios are on the desk. It seems that all business must pass through this office, day or night. This is the eastern half of the room, and through the doorway to the right you can see the dock. Back to the west, the office continues. A %^C226%^%^small sign %^C136%^is posted on the wall behind the desk for you to read.%^CRST%^\n");
    ...
    set_exits(([
        "west" : TCITY+"dock_taxes2",
        "east" : "/d/shadow/virtual/sea/torm.dock"
    ]));
