...
void create()
{
  ::create();
   ...
   set_long(
   "A Large Open Office on the Boardwalk.\n"
   ...
   "all business must pass through this office, day or night.  This is the "+
   "eastern half of the room, and through the doorway to the right you can "+
   "see the dock.  Back to the west, the office continues.  A %^YELLOW%^"+
   "small sign %^RESET%^"+
  ...
  set_pre_exit_functions(({"west"}),({"Pay_taxes"}));
}
