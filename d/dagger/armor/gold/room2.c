...
void create(){
    ...
    set_long(
      "You are behind the great door that created the prison for the creature that was held here.  There is much blood here, from countless sacrifices of innocents, and the occasional adventurer that wasn't lucky enough to have a quick death."
    );
