...
void create(){
    ...
    set_short("%^RESET%^%^CRST%^%^C255%^Outside the remains of a large inn%^CRST%^");
    set_long("%^RESET%^%^CRST%^%^C058%^A towering %^C059%^cathedral%^RESET%^%^C058%^ was built to the northwest on the very crest of a hill, though all that remains now is the shattered husk of what was. Piles of stone and wood are scattered about. %^C245%^A %^C059%^%^sign%^RESET%^%^C245%^ hanging above the door proudly declares it to be %^RESET%^%^CRST%^%^C244%^\"T%^C243%^h%^C059%^e %^C196%^B%^C124%^lo%^C196%^od%^C124%^y %^RESET%^%^C124%^S%^C196%^co%^C124%^ur%^C196%^g%^C124%^e%^RESET%^ %^C244%^I%^C243%^n%^C059%^n\"%^RESET%^%^C245%^.%^CRST%^\n");
