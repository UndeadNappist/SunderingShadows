...
void create(){
    ...
    set_long("%^RESET%^%^CRST%^%^C030%^%^This heavily traveled %^C250%^r%^C247%^o%^C244%^a%^C059%^d %^C030%^cuts its way through the Dagger region, connecting several city-states in the area. The %^C036%^lush fields %^C030%^of the %^C144%^Yniam Plains %^RESET%^%^C030%^spread out to the west, the tall grasses and brush waving lightly in the breeze. In the east, the ruins of some dwellings can be seen, a scar among the surrounding scenery. %^C028%^There is a bend in the road with a curious %^C058%^camp %^C028%^set up to the side.%^CRST%^\n");
