...
void create(){
	...
	symbol1 = "a %^BOLD%^noble knight %^RESET%^chess piece";
	symbol2 = "an ancient %^GREEN%^oak tree %^RESET%^with spreading branches";
	background = "a narrow %^ORANGE%^path %^RESET%^winding through rolling hills";
