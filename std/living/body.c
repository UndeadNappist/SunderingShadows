...
void recalculate_max_hp_from_feats()
{
    int num;
...
{
    player_data["general"]["functional_max_hp"] = max_hp_components["feats"] + query_max_hp_base() + query_max_hp_bonus() + 1;
}
