...
mapping class_featmap(string myspec)   // "dual wield" is default setting
{
    ...
    case "twohanded":
        ...
        break;
    case "mounted":
        return ([ 1 : ({ "favored enemy", "mounted combat", "light armor proficiency","shield proficiency", "simple weapon proficiency", "martial weapon proficiency", "track" }), 3 : ({ "rangers endurance", "favored terrain" }), 4 : ({ "animal companion" }), 5 : ({ "ride-by attack" }), 7 : ({ "hunters bond" }), 9 : ({ "charge", "evasion" }), 10 : ({ "quarry" }), 11 : ({ "second favored enemy" }), 13 : ({ "trample", "second favored terrain" }), 17 : ({ "third favored enemy" }), 18 : ({ "improved quarry" }), 19 : ({ "third favored terrain" }), 21 : ({ "seen it before" }), 31 : ({ "wild hunter" }), ]);
        break;
    default:
        return ([ 1 : ({ "favored enemy", "ambidexterity", "light armor proficiency","shield proficiency", "simple weapon proficiency", "martial weapon proficiency", "track" }), 3 : ({ "rangers endurance", "favored terrain" }), 4 : ({ "animal companion" }), 5 : ({ "whirl" }), 7 : ({ "hunters bond" }), 9 : ({ "two weapon fighting", "evasion" }), 10 : ({ "quarry" }), 11 : ({ "second favored enemy" }), 13 : ({ "improved two weapon fighting", "second favored terrain" }), 17 : ({ "unassailable parry", "third favored enemy" }), 18 : ({ "improved quarry" }), 19 : ({ "third favored terrain" }), 21 : ({ "seen it before" }), 31 : ({ "wild hunter" }),  ]);
        break;
