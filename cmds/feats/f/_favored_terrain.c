...
void create()
{
    ...
    feat_desc("This feat allows a ranger to focus their knowledge and training for operating within a favored terrain of their choice. While within their favored terrain, the ranger gains +2 to stealth, perception, and survival skills. You can select from the following favored terrain: \n\n"+"%^GREEN%^"+implode(valid_choices, "\n")+"%^RESET%^\n\n\To start selection process type <favored_terrain> [TYPE].");
    allow_tripped(1);
