...
void create() 
{
    ...
    feat_desc("The warlock gains several new invocations which harness his or her command of hellfire. The invocations 'hellfire shield', 'infernal healing', 'fire storm', and 'fiery body'are added to the known spell list.");
    permanent(1);
