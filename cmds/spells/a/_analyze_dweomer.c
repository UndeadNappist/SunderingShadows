...
void create()
{
    ...
    set_description("This spell allows you to sense what spells and magical afflictions affect the target. If the target passes their save they will know the caster has analyzed them with a magic probe.");
    set_verbal_comp();
    set_somatic_comp();
