...
void create()
{
    ...
    set_description("You convert a thin layer of the ground below your enemies to molten glass that cools quickly. Creatures on the glass that don't jump off in time will be burned and will trip as the surface solidifies.");
    set_verbal_comp();
    set_somatic_comp();
    set_save("reflex");
    splash_spell(3);
