...
void create() {
    ...
    set_description("This spell sends waves of intense pleasure that cause all within range to falter. Affected creatures are stunned for up to three rounds on a failed save, or staggered for one round on a successful save.");
    set_save("will");
    set_verbal_comp();
    set_somatic_comp();
    splash_spell(3);
