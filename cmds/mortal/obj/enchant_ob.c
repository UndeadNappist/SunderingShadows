...
#define restricted_skills ({ "craft, armorsmith", "craft, jeweller", "craft, leatherworker", "craft, weaponsmith", "craft, woodworker", "craft, tailor", "craft, leatherwork", "light", "spellTurning", "missChance", "magic resistance", "shieldMiss", "combat maneuver bonus", "combat maneuver defense", "untyped resistance" })
...
int do_exp_cost(object tp, object item, int cost)
{
    ...
    exp_cost = cost * (10 * (tp->query_base_character_level() / 2));  // might need some tweaking here.
